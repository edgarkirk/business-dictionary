...
class ArchitectureTest {
    ...
    @Test
    void domain_must_not_depend_on_any_application_layer() {
        noClasses().that().resideInAPackage("..domain..")
                .should().dependOnClassesThat()
                .resideInAnyPackage(
                        "com.epam.businessdictionary.application..",
                        "com.epam.businessdictionary.api..",
                        "com.epam.businessdictionary.persistence..",
                        "com.epam.businessdictionary.config..")
                .check(classes);
    }
}
